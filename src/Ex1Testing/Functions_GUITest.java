...
//	}
	...
	{
		_data.drawFunctions("drawSuccess.JSON");
		_data.drawFunctions("DdrawSuccess.JSON");//file not exist,default value
		_data.drawFunctions("wrongformat.JSON");//wrong format,default value
	}
	@Test
