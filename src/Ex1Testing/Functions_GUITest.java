...
//	}
	...
	void testInitFromFile()
	{
		...
		assertThrows( IOException.class,() -> fg.initFromFile("function_file.txt"));
	}
	@Test
	void testSaveToFile()
	{
		assertThrows( IOException.class,() -> _data.saveToFile("new.txt"));
	}
	...
	{
		_data.drawFunctions(512,512,new Range(-10,10),new Range(-10,10),100);
	}
